...
try {
    ...
    $ngrok_url = "https://b29029ed4e59.ngrok-free.app"; // GANTI URL NGROK BARU
    $link_faktur = $ngrok_url . "/alamadventure/invoice.php?order=" . $order_code;
    ...
    if ($payment_method === 'cod') {
        ...
        $totQty = 0; foreach ($_SESSION['cart'] as $c) $totQty += $c['qty'];
